...
# undef AUDIT_FEATURE_CHANGE
 ...
 XLAT(AUDIT_AVC),
 #define XLAT_VAL_61 ((unsigned) (AUDIT_AVC))
 #define XLAT_STR_61 STRINGIFY(AUDIT_AVC)
 XLAT(AUDIT_SELINUX_ERR),
 #define XLAT_VAL_62 ((unsigned) (AUDIT_SELINUX_ERR))
 #define XLAT_STR_62 STRINGIFY(AUDIT_SELINUX_ERR)
 XLAT(AUDIT_AVC_PATH),
 #define XLAT_VAL_63 ((unsigned) (AUDIT_AVC_PATH))
 #define XLAT_STR_63 STRINGIFY(AUDIT_AVC_PATH)
 XLAT(AUDIT_MAC_POLICY_LOAD),
 #define XLAT_VAL_64 ((unsigned) (AUDIT_MAC_POLICY_LOAD))
 #define XLAT_STR_64 STRINGIFY(AUDIT_MAC_POLICY_LOAD)
 XLAT(AUDIT_MAC_STATUS),
 #define XLAT_VAL_65 ((unsigned) (AUDIT_MAC_STATUS))
 #define XLAT_STR_65 STRINGIFY(AUDIT_MAC_STATUS)
 XLAT(AUDIT_MAC_CONFIG_CHANGE),
 #define XLAT_VAL_66 ((unsigned) (AUDIT_MAC_CONFIG_CHANGE))
 #define XLAT_STR_66 STRINGIFY(AUDIT_MAC_CONFIG_CHANGE)
 XLAT(AUDIT_MAC_UNLBL_ALLOW),
 #define XLAT_VAL_67 ((unsigned) (AUDIT_MAC_UNLBL_ALLOW))
 #define XLAT_STR_67 STRINGIFY(AUDIT_MAC_UNLBL_ALLOW)
 XLAT(AUDIT_MAC_CIPSOV4_ADD),
 #define XLAT_VAL_68 ((unsigned) (AUDIT_MAC_CIPSOV4_ADD))
 #define XLAT_STR_68 STRINGIFY(AUDIT_MAC_CIPSOV4_ADD)
 XLAT(AUDIT_MAC_CIPSOV4_DEL),
 #define XLAT_VAL_69 ((unsigned) (AUDIT_MAC_CIPSOV4_DEL))
 #define XLAT_STR_69 STRINGIFY(AUDIT_MAC_CIPSOV4_DEL)
 XLAT(AUDIT_MAC_MAP_ADD),
 #define XLAT_VAL_70 ((unsigned) (AUDIT_MAC_MAP_ADD))
 #define XLAT_STR_70 STRINGIFY(AUDIT_MAC_MAP_ADD)
 XLAT(AUDIT_MAC_MAP_DEL),
 #define XLAT_VAL_71 ((unsigned) (AUDIT_MAC_MAP_DEL))
 #define XLAT_STR_71 STRINGIFY(AUDIT_MAC_MAP_DEL)
 XLAT(AUDIT_MAC_IPSEC_ADDSA),
 #define XLAT_VAL_72 ((unsigned) (AUDIT_MAC_IPSEC_ADDSA))
 #define XLAT_STR_72 STRINGIFY(AUDIT_MAC_IPSEC_ADDSA)
 XLAT(AUDIT_MAC_IPSEC_DELSA),
 #define XLAT_VAL_73 ((unsigned) (AUDIT_MAC_IPSEC_DELSA))
 #define XLAT_STR_73 STRINGIFY(AUDIT_MAC_IPSEC_DELSA)
 XLAT(AUDIT_MAC_IPSEC_ADDSPD),
 #define XLAT_VAL_74 ((unsigned) (AUDIT_MAC_IPSEC_ADDSPD))
 #define XLAT_STR_74 STRINGIFY(AUDIT_MAC_IPSEC_ADDSPD)
 XLAT(AUDIT_MAC_IPSEC_DELSPD),
 #define XLAT_VAL_75 ((unsigned) (AUDIT_MAC_IPSEC_DELSPD))
 #define XLAT_STR_75 STRINGIFY(AUDIT_MAC_IPSEC_DELSPD)
 XLAT(AUDIT_MAC_IPSEC_EVENT),
 #define XLAT_VAL_76 ((unsigned) (AUDIT_MAC_IPSEC_EVENT))
 #define XLAT_STR_76 STRINGIFY(AUDIT_MAC_IPSEC_EVENT)
 XLAT(AUDIT_MAC_UNLBL_STCADD),
 #define XLAT_VAL_77 ((unsigned) (AUDIT_MAC_UNLBL_STCADD))
 #define XLAT_STR_77 STRINGIFY(AUDIT_MAC_UNLBL_STCADD)
 XLAT(AUDIT_MAC_UNLBL_STCDEL),
 #define XLAT_VAL_78 ((unsigned) (AUDIT_MAC_UNLBL_STCDEL))
 #define XLAT_STR_78 STRINGIFY(AUDIT_MAC_UNLBL_STCDEL)
 XLAT(AUDIT_MAC_CALIPSO_ADD),
 #define XLAT_VAL_79 ((unsigned) (AUDIT_MAC_CALIPSO_ADD))
 #define XLAT_STR_79 STRINGIFY(AUDIT_MAC_CALIPSO_ADD)
 XLAT(AUDIT_MAC_CALIPSO_DEL),
 #define XLAT_VAL_80 ((unsigned) (AUDIT_MAC_CALIPSO_DEL))
 #define XLAT_STR_80 STRINGIFY(AUDIT_MAC_CALIPSO_DEL)

 XLAT(AUDIT_ANOM_PROMISCUOUS),
 #define XLAT_VAL_81 ((unsigned) (AUDIT_ANOM_PROMISCUOUS))
 #define XLAT_STR_81 STRINGIFY(AUDIT_ANOM_PROMISCUOUS)
 XLAT(AUDIT_ANOM_ABEND),
 #define XLAT_VAL_82 ((unsigned) (AUDIT_ANOM_ABEND))
 #define XLAT_STR_82 STRINGIFY(AUDIT_ANOM_ABEND)
 XLAT(AUDIT_ANOM_LINK),
 #define XLAT_VAL_83 ((unsigned) (AUDIT_ANOM_LINK))
 #define XLAT_STR_83 STRINGIFY(AUDIT_ANOM_LINK)
 XLAT(AUDIT_ANOM_CREAT),
 #define XLAT_VAL_84 ((unsigned) (AUDIT_ANOM_CREAT))
 #define XLAT_STR_84 STRINGIFY(AUDIT_ANOM_CREAT)
 XLAT(AUDIT_LAST_KERN_ANOM_MSG),
 #define XLAT_VAL_85 ((unsigned) (AUDIT_LAST_KERN_ANOM_MSG))
 #define XLAT_STR_85 STRINGIFY(AUDIT_LAST_KERN_ANOM_MSG)

 XLAT(AUDIT_INTEGRITY_DATA),
 #define XLAT_VAL_86 ((unsigned) (AUDIT_INTEGRITY_DATA))
 #define XLAT_STR_86 STRINGIFY(AUDIT_INTEGRITY_DATA)
 XLAT(AUDIT_INTEGRITY_METADATA),
 #define XLAT_VAL_87 ((unsigned) (AUDIT_INTEGRITY_METADATA))
 #define XLAT_STR_87 STRINGIFY(AUDIT_INTEGRITY_METADATA)
 XLAT(AUDIT_INTEGRITY_STATUS),
 #define XLAT_VAL_88 ((unsigned) (AUDIT_INTEGRITY_STATUS))
 #define XLAT_STR_88 STRINGIFY(AUDIT_INTEGRITY_STATUS)
 XLAT(AUDIT_INTEGRITY_HASH),
 #define XLAT_VAL_89 ((unsigned) (AUDIT_INTEGRITY_HASH))
 #define XLAT_STR_89 STRINGIFY(AUDIT_INTEGRITY_HASH)
 XLAT(AUDIT_INTEGRITY_PCR),
 #define XLAT_VAL_90 ((unsigned) (AUDIT_INTEGRITY_PCR))
 #define XLAT_STR_90 STRINGIFY(AUDIT_INTEGRITY_PCR)
 XLAT(AUDIT_INTEGRITY_RULE),
 #define XLAT_VAL_91 ((unsigned) (AUDIT_INTEGRITY_RULE))
 #define XLAT_STR_91 STRINGIFY(AUDIT_INTEGRITY_RULE)
 XLAT(AUDIT_INTEGRITY_EVM_XATTR),
 #define XLAT_VAL_92 ((unsigned) (AUDIT_INTEGRITY_EVM_XATTR))
 #define XLAT_STR_92 STRINGIFY(AUDIT_INTEGRITY_EVM_XATTR)
 XLAT(AUDIT_INTEGRITY_POLICY_RULE),
 #define XLAT_VAL_93 ((unsigned) (AUDIT_INTEGRITY_POLICY_RULE))
 #define XLAT_STR_93 STRINGIFY(AUDIT_INTEGRITY_POLICY_RULE)

 XLAT(AUDIT_KERNEL),
 #define XLAT_VAL_94 ((unsigned) (AUDIT_KERNEL))
 #define XLAT_STR_94 STRINGIFY(AUDIT_KERNEL)

 XLAT(AUDIT_FIRST_USER_MSG2),
 #define XLAT_VAL_95 ((unsigned) (AUDIT_FIRST_USER_MSG2))
 #define XLAT_STR_95 STRINGIFY(AUDIT_FIRST_USER_MSG2)
 XLAT(AUDIT_LAST_USER_MSG2),
 #define XLAT_VAL_96 ((unsigned) (AUDIT_LAST_USER_MSG2))
 #define XLAT_STR_96 STRINGIFY(AUDIT_LAST_USER_MSG2)
};
static
