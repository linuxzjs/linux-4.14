...
static const struct xlat_data sock_ip_options_xdata[] = {
 ...
 #define XLAT_VAL_37 ((unsigned) (IP_UNBLOCK_SOURCE))
 #define XLAT_STR_37 STRINGIFY(IP_UNBLOCK_SOURCE)
#endif
#if defined(IP_BLOCK_SOURCE) || (defined(HAVE_DECL_IP_BLOCK_SOURCE) && HAVE_DECL_IP_BLOCK_SOURCE)
  XLAT(IP_BLOCK_SOURCE),
 #define XLAT_VAL_38 ((unsigned) (IP_BLOCK_SOURCE))
 #define XLAT_STR_38 STRINGIFY(IP_BLOCK_SOURCE)
#endif
 ...
 #define XLAT_VAL_39 ((unsigned) (IP_ADD_SOURCE_MEMBERSHIP))
 #define XLAT_STR_39 STRINGIFY(IP_ADD_SOURCE_MEMBERSHIP)
#endif
 ...
 #define XLAT_VAL_40 ((unsigned) (IP_DROP_SOURCE_MEMBERSHIP))
 #define XLAT_STR_40 STRINGIFY(IP_DROP_SOURCE_MEMBERSHIP)
#endif
#if defined(MCAST_JOIN_GROUP) || (defined(HAVE_DECL_MCAST_JOIN_GROUP) && HAVE_DECL_MCAST_JOIN_GROUP)
  XLAT(MCAST_JOIN_GROUP),
 #define XLAT_VAL_41 ((unsigned) (MCAST_JOIN_GROUP))
 #define XLAT_STR_41 STRINGIFY(MCAST_JOIN_GROUP)
#endif
#if defined(MCAST_BLOCK_SOURCE) || (defined(HAVE_DECL_MCAST_BLOCK_SOURCE) && HAVE_DECL_MCAST_BLOCK_SOURCE)
  XLAT(MCAST_BLOCK_SOURCE),
 #define XLAT_VAL_42 ((unsigned) (MCAST_BLOCK_SOURCE))
 #define XLAT_STR_42 STRINGIFY(MCAST_BLOCK_SOURCE)
#endif
 ...
 #define XLAT_VAL_43 ((unsigned) (MCAST_UNBLOCK_SOURCE))
 #define XLAT_STR_43 STRINGIFY(MCAST_UNBLOCK_SOURCE)
#endif
#if defined(MCAST_LEAVE_GROUP) || (defined(HAVE_DECL_MCAST_LEAVE_GROUP) && HAVE_DECL_MCAST_LEAVE_GROUP)
  XLAT(MCAST_LEAVE_GROUP),
 #define XLAT_VAL_44 ((unsigned) (MCAST_LEAVE_GROUP))
 #define XLAT_STR_44 STRINGIFY(MCAST_LEAVE_GROUP)
#endif
 ...
 #define XLAT_VAL_45 ((unsigned) (MCAST_JOIN_SOURCE_GROUP))
 #define XLAT_STR_45 STRINGIFY(MCAST_JOIN_SOURCE_GROUP)
#endif
 ...
 #define XLAT_VAL_46 ((unsigned) (MCAST_LEAVE_SOURCE_GROUP))
 #define XLAT_STR_46 STRINGIFY(MCAST_LEAVE_SOURCE_GROUP)
#endif
#if defined(MCAST_MSFILTER) || (defined(HAVE_DECL_MCAST_MSFILTER) && HAVE_DECL_MCAST_MSFILTER)
  XLAT(MCAST_MSFILTER),
 #define XLAT_VAL_47 ((unsigned) (MCAST_MSFILTER))
 #define XLAT_STR_47 STRINGIFY(MCAST_MSFILTER)
#endif
#if defined(IP_MULTICAST_ALL) || (defined(HAVE_DECL_IP_MULTICAST_ALL) && HAVE_DECL_IP_MULTICAST_ALL)
  XLAT(IP_MULTICAST_ALL),
 #define XLAT_VAL_48 ((unsigned) (IP_MULTICAST_ALL))
 #define XLAT_STR_48 STRINGIFY(IP_MULTICAST_ALL)
#endif
#if defined(IP_UNICAST_IF) || (defined(HAVE_DECL_IP_UNICAST_IF) && HAVE_DECL_IP_UNICAST_IF)
  XLAT(IP_UNICAST_IF),
 #define XLAT_VAL_49 ((unsigned) (IP_UNICAST_IF))
 #define XLAT_STR_49 STRINGIFY(IP_UNICAST_IF)
#endif
};
static
